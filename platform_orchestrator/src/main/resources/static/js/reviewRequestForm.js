...
function renderAdditionalButton() {
    timeSlotCounter++;
    $("#timeContainer")
        .append("<input type=\"time\" class=\"input-group timepicker\" id=\"review-timeSlots" + timeSlotCounter + "\" name=\"timeSlots\" placeholder=\"Выберите время\" th:required=\"required\">")
        .ready(function() {
