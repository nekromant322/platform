    ...
    $.ajax({
        ...
        success: function (currentUser) {
            ...
            $('#cardBody').append(
                ...
                '                    г. Иваново                                                                              03.08.2018 г.' +
                '                    Я, Ковтун Инна Олеговна, паспорт 2495 564738, выдан Ленинским РОВД г. Иваново, адрес регистрации: г.' +
                '                    Иваново,ул. Мельничная д.73, кв. 8, даю свое согласие ОАО«КомЖилФонд» на обработку моих персональных' +
                '                    данных. Согласие касается фамилии, имени, отчества, данных о поле, дате рождении, гражданстве, типе' +
                '                    документа, удостоверяющем личность (его серии, номере, дате и месте выдачи), а также сведений из' +
                '                    трудовой книжки: опыте работы, месте работы и должности.' +
                '                    Я даю согласие на использование персональных данных исключительно в целях формирования кадрового' +
                '                    документооборота предприятия, бухгалтерских операций и налоговых отчислений, а также на хранение' +
                '                    всех вышеназванных данных на электронных носителях. Также данным согласием я разрешаю сбор моих' +
                '                    персональных данных, их хранение, систематизацию, обновление, использование (в т.ч. передачу третьим' +
                '                    лицам для обмена информацией), а также осуществление любых иных действий, предусмотренных' +
                '                    действующим законом Российской Федерации.' +
                '                    До моего сведения доведено, что ОАО«КомЖилФонд» гарантирует обработку моих персональных' +
                '                    данных в соответствии с действующим законодательством Российской Федерации. Срок действия' +
                '                    данного согласия не ограничен. Согласие может быть отозвано в любой момент по моему  письменному' +
                '                    заявлению.' +
