...
public class HelpMeRestController {
    ...
    @Autowired
    private Cache<Integer, HelpMeDTO> helpMeDTOCache;

    @PostMapping("/helpMe")
    public int postHelpMeDTO(@RequestBody HelpMeDTO helpMeDTO) {
    ...
    public HelpMeDTO getHelpMeCachedDTO(@PathVariable int key) {
