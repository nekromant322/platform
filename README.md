...
(Telegram chatId для тестовых пользователей будет не валиден. 
Валидный чат с собой, в который бот сможет прислать сообщение, можно сделать, если собственноручно зарегистрироваться в платформе)
