...
public class SalaryDTO {
     ...
     */
    @ApiModelProperty(value = "Лист с датами зарплат ('ярлыки', которые содержат даты для графика зарплат), даты для каждого юзера начинаются с принятия оффера по сегодняшний день")
